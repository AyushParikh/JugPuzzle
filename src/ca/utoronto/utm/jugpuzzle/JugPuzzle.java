...
import ca.utoronto.utm.assignment1.jugpuzzle.Jug;
...
public class JugPuzzle extends Observable {
	...
	public void move(int from, int to) {
		...
		this.setChanged();
		this.notifyObservers("moved from jug " + from + "to jug " + to);
	}
	...
	/**
	 * returns the jug object
	 * @param i, which number of jug to return.
	 * @return Jug object
	 */
